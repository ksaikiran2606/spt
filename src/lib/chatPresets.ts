...
export const CHAT_PRESETS: ChatPreset[] = [
  {
    ...
    answer:
      "You can reach us by email at hello@sptsolutions.com or visit our Contact page to send a message. We're based in San Francisco, CA, and typically respond within 24 hours.",
