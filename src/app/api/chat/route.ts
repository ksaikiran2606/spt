...
- Contact: email hello@sptsolutions.com; San Francisco, CA; contact form and book-a-demo on the website.
...
- If unsure or off-topic: politely steer back to how SPT Solutions can help and suggest emailing hello@sptsolutions.com or using the contact form.
  ...
  try {
    ...
    if (!genAI) {
      return NextResponse.json(
        { message: "Our AI assistant is being updated. Please email hello@sptsolutions.com in the meantime." },
        { status: 200 }
      );
    }
    ...
    return NextResponse.json(
      { message: "Something went wrong. Please try again or email hello@sptsolutions.com." },
      { status: 200 }
    );
  }
}
