...
export const metadata: Metadata = {
  title: "Privacy Policy | SPT Solutions",
  description: "Privacy policy for SPT Solutions. How we collect, use, and protect your data.",
};
        ...
        <div className="mt-10 space-y-8 text-[var(--foreground)]">
          <section>
            ...
            <p className="text-[var(--muted)] leading-relaxed">
              SPT Solutions (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website at sptsolutions.com and our AI services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-[var(--muted)] space-y-1 ml-2">
          ...
          <section>
            ...
            <p className="text-[var(--muted)] leading-relaxed">
              We use the information we collect to respond to inquiries, send booking confirmations, provide AI-powered recommendations and chat responses, improve our services, and communicate with you about SPT Solutions offerings. We do not sell your personal information to third parties.
            </p>
          </section>
